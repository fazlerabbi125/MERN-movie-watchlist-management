...
const Details = () => {
    ...
    return (
        <section className="mt-5">
            ...
            {data && (<div className="data card w-75 mx-auto mb-5">
                <div className="card-header">
                    ...
                    <div className="row align-items-center">
                        <img src={data.imgUrl || poster} alt="Poster" className="data__img mb-2 col-2 img-fluid" />
                ...
                <div className="card-body">
                    ...
                    <div className="row justify-content-around mt-4">
                        <div className="col-auto">
                            <div><span className="data__property--muted">Genre:</span> {data.genre}</div>
                            <div><span className="data__property--muted">Year:</span> {data.year}</div>
                            <div><span className="data__property--muted">Rating:</span> {data.rating ? data.rating : "Unrated"}</div>
                        </div>
                        <div className="col-auto">
                            <div><span className="data__property--muted">Country:</span> {data.country}</div>
                            <div><span className="data__property--muted">Language:</span> {data.language}</div>
                        </div>
